...
[![Chrome Web Store](https://img.shields.io/chrome-web-store/v/mcnkakgipdiajgeelckdbghaelnebjkm?style=flat-square&label=Chrome%20Web%20Store&color=057642)](https://chrome.google.com/webstore/detail/mcnkakgipdiajgeelckdbghaelnebjkm)
[![Product Hunt](https://img.shields.io/badge/Product%20Hunt-Live%20Today-ff6154?style=flat-square&logo=producthunt)](https://www.producthunt.com/posts/feedready)

---

## Install

**[→ Install FeedReady from the Chrome Web Store](https://chrome.google.com/webstore/detail/mcnkakgipdiajgeelckdbghaelnebjkm)**

Works on Chrome and Edge. No sign-up required. Free to install.

Or use the **[web tool](https://ansh.asia/feed-ready)** — works in any browser including mobile, no install needed.
...
- **No permissions overreach** — only requests `storage` and host access to `linkedin.com`
...
- [x] Real metadata detection with amber tag display
- [x] Web tool at ansh.asia/feed-ready (no install needed)
...
FeedReady is a product of **Alara Styles**, operated by Anshumaan Vishnu.
...
[![Chrome Web Store](https://img.shields.io/badge/Chrome_Web_Store-Install_Free-057642?style=flat-square&logo=googlechrome)](https://chrome.google.com/webstore/detail/mcnkakgipdiajgeelckdbghaelnebjkm)
...
[![Product Hunt](https://img.shields.io/badge/Product%20Hunt-FeedReady-ff6154?style=flat-square&logo=producthunt)](https://www.producthunt.com/posts/feedready)
